...
class TestReproducibility:
    ...
    def test_gymnasium_environment_reproducibility(self):
        ...
        for _ in range(10):
            ...
            assert np.allclose(obs1, obs2), f"Observations should be identical at step {_}"
            assert reward1 == reward2, f"Rewards should be identical at step {_}"
            assert terminated1 == terminated2, f"Termination should be identical at step {_}"
            assert truncated1 == truncated2, f"Truncation should be identical at step {_}"
